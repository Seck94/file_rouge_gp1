...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\GroupeTagTagsFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ReferentielFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserFixtures($b), 'groups' => []]]);
