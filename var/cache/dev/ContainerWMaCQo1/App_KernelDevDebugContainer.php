...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CommentaireGeneralController' => 'getCommentaireGeneralControllerService',
            ...
            'App\\UserServices\\UserServices' => 'getUserServicesService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\BriefLivrableAttenduRepository' => ['privates', 'App\\Repository\\BriefLivrableAttenduRepository', 'getBriefLivrableAttenduRepositoryService', true],
            ...
            'App\\Repository\\CommentaireGeneralRepository' => ['privates', 'App\\Repository\\CommentaireGeneralRepository', 'getCommentaireGeneralRepositoryService', true],
            ...
            'App\\Repository\\LivrableRenduRepository' => ['privates', 'App\\Repository\\LivrableRenduRepository', 'getLivrableRenduRepositoryService', true],
            'App\\Repository\\LivrableRepository' => ['privates', 'App\\Repository\\LivrableRepository', 'getLivrableRepositoryService', true],
            ...
            'App\\Repository\\PromoBriefApprenantRepository' => ['privates', 'App\\Repository\\PromoBriefApprenantRepository', 'getPromoBriefApprenantRepositoryService', true],
            'App\\Repository\\PromoBriefRepository' => ['privates', 'App\\Repository\\PromoBriefRepository', 'getPromoBriefRepositoryService', true],
            ...
            'App\\Repository\\StatistiquesCompetencesRepository' => ['privates', 'App\\Repository\\StatistiquesCompetencesRepository', 'getStatistiquesCompetencesRepositoryService', true],
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-1MvPJhX2W', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b3k8SZI+3V', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ym1nVy+Jke', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EHefmfU56M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EclzicWOX4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_groupe_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_groupe_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityGroupeApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            ...
            'annotated_app_entity_promo_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_promo_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityPromoApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            ...
            'annotated_app_entity_promo_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J6Ks16o4dL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('md+F++VUWy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\BriefVoter'] ?? $this->load('getBriefVoterService'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CompetenceVoter'] ?? $this->load('getCompetenceVoterService'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GroupecompetenceVoter'] ?? $this->load('getGroupecompetenceVoterService'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GroupetagVoter'] ?? $this->load('getGroupetagVoterService'));
            yield 7 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ProfilVoter'] ?? $this->load('getProfilVoterService'));
            yield 8 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ProfilsortieVoter'] ?? $this->load('getProfilsortieVoterService'));
            yield 9 => ($this->privates['debug.security.voter.App\\Security\\Voter\\PromoVoter'] ?? $this->load('getPromoVoterService'));
            yield 10 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ReferentielVoter'] ?? $this->load('getReferentielVoterService'));
            yield 11 => ($this->privates['debug.security.voter.App\\Security\\Voter\\TagVoter'] ?? $this->load('getTagVoterService'));
        }, 12), 'affirmative', false, true));
    }
