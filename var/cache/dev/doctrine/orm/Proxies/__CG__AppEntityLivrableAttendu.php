 ...
 */
class LivrableAttendu extends \App\Entity\LivrableAttendu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LivrableAttendu $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\LivrableAttendu
    {
