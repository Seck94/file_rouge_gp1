...
class Apprenant extends \App\Entity\Apprenant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'profilsortie', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'groupe', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'livrables', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'livrableRendus', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'promoBriefApprenant', '' . "\0" . 'App\\Entity\\Apprenant' . "\0" . 'statistiquesCompetences'];
        }
     ...
     * {@inheritDoc}
     */
    public function getPromoBriefApprenant(): ?\App\Entity\PromoBriefApprenant
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPromoBriefApprenant', []);

        return parent::getPromoBriefApprenant();
    }

    /**
     * {@inheritDoc}
     */
    public function setPromoBriefApprenant(?\App\Entity\PromoBriefApprenant $promoBriefApprenant): \App\Entity\Apprenant
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPromoBriefApprenant', [$promoBriefApprenant]);

        return parent::setPromoBriefApprenant($promoBriefApprenant);
    }
     ...
     * {@inheritDoc}
     */
    public function addPromo(\App\Entity\Promo $promo): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removePromo(\App\Entity\Promo $promo): \App\Entity\User
    {
